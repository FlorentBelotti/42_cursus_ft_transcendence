 ...
 * ║                   Local Pong Game                        ║
 * ╠══════════════════════════════════════════════════════════╣
 * ║ Client-side local Pong game implementation               ║
 * ║                                                          ║
 * ║ • Manages game loop and rendering                        ║
 * ║ • Handles paddle and ball physics                        ║
 * ║ • Processes user input for paddle movement               ║
 * ║ • Manages score tracking and win conditions              ║
 * ║ • Provides game reset and cleanup functionality          ║
 * ╚══════════════════════════════════════════════════════════╝
 */
