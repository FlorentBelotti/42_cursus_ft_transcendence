# Generated by Django 4.2 on 2025-04-01 08:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='profile_pictures/arcane_from_arcane.png', null=True, upload_to='profile_pictures/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('match_type', models.CharField(choices=[('regular', 'Regular Match'), ('tournament', 'Tournament')], default='regular', max_length=15)),
